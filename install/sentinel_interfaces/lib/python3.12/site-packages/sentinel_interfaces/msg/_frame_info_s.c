...
bool sentinel_interfaces__msg__frame_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("sentinel_interfaces.msg._frame_info.FrameInfo", full_classname_dest, 45) == 0);
  }
  sentinel_interfaces__msg__FrameInfo * ros_message = _ros_message;
  {  // width
...
PyObject * sentinel_interfaces__msg__frame_info__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("sentinel_interfaces.msg._frame_info");
