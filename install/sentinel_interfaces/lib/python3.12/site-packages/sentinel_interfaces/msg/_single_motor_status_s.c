...
bool sentinel_interfaces__msg__single_motor_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("sentinel_interfaces.msg._single_motor_status.SingleMotorStatus", full_classname_dest, 62) == 0);
  }
  sentinel_interfaces__msg__SingleMotorStatus * ros_message = _ros_message;
  {  // position
...
{
  /* NOTE(esteve): Call constructor of SingleMotorStatus */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("sentinel_interfaces.msg._single_motor_status");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SingleMotorStatus");
