...
bool sentinel_interfaces__msg__motor_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // pan
    ...
    if (!sentinel_interfaces__msg__single_motor_status__convert_from_py(field, &ros_message->pan)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // tilt
    ...
    if (!sentinel_interfaces__msg__single_motor_status__convert_from_py(field, &ros_message->tilt)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * sentinel_interfaces__msg__motor_status__convert_to_py(void * raw_ros_message)
{
  ...
  {  // pan
    PyObject * field = NULL;
    field = sentinel_interfaces__msg__single_motor_status__convert_to_py(&ros_message->pan);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // tilt
    PyObject * field = NULL;
    field = sentinel_interfaces__msg__single_motor_status__convert_to_py(&ros_message->tilt);
    if (!field) {
      return NULL;
    }
    {
