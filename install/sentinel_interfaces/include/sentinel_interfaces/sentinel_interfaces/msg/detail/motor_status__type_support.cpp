...
{
  new (message_memory) sentinel_interfaces::msg::MotorStatus(_init);
}

void MotorStatus_fini_function(void * message_memory)
{
  auto typed_message = static_cast<sentinel_interfaces::msg::MotorStatus *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember MotorStatus_message_member_array[2] = {
  {
    ...
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<sentinel_interfaces::msg::SingleMotorStatus>(),  // members of sub message
    false,  // is key
    false,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(sentinel_interfaces::msg::MotorStatus, pan),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(sentinel_interfaces::msg::MotorStatus, tilt),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers MotorStatus_message_members = {
  ...
  2,  // number of fields
  sizeof(sentinel_interfaces::msg::MotorStatus),
...
{
  return &::sentinel_interfaces::msg::rosidl_typesupport_introspection_cpp::MotorStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, sentinel_interfaces, msg, MotorStatus)() {
  return &::sentinel_interfaces::msg::rosidl_typesupport_introspection_cpp::MotorStatus_message_type_support_handle;
}
