...
class Metaclass_MotorStatus(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from sentinel_interfaces.msg import SingleMotorStatus
            if SingleMotorStatus.__class__._TYPE_SUPPORT is None:
                SingleMotorStatus.__class__.__import_type_support__()
...
class MotorStatus(metaclass=Metaclass_MotorStatus):
    ...
    _fields_and_field_types = {
        'pan': 'sentinel_interfaces/SingleMotorStatus',
        'tilt': 'sentinel_interfaces/SingleMotorStatus',
    }

    # This attribute is used to store an rosidl_parser.definition variable
    # related to the data type of each of the components the message.
    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['sentinel_interfaces', 'msg'], 'SingleMotorStatus'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['sentinel_interfaces', 'msg'], 'SingleMotorStatus'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from sentinel_interfaces.msg import SingleMotorStatus
        self.pan = kwargs.get('pan', SingleMotorStatus())
        from sentinel_interfaces.msg import SingleMotorStatus
        self.tilt = kwargs.get('tilt', SingleMotorStatus())
    ...
    def pan(self, value):
        if self._check_fields:
            from sentinel_interfaces.msg import SingleMotorStatus
            assert \
                isinstance(value, SingleMotorStatus), \
                "The 'pan' field must be a sub message of type 'SingleMotorStatus'"
        self._pan = value
    ...
    def tilt(self, value):
        if self._check_fields:
            ...
            assert \
                isinstance(value, SingleMotorStatus), \
                "The 'tilt' field must be a sub message of type 'SingleMotorStatus'"
        self._tilt = value
