...
bool sentinel_interfaces__msg__detection__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("sentinel_interfaces.msg._detection.Detection", full_classname_dest, 44) == 0);
  }
  sentinel_interfaces__msg__Detection * ros_message = _ros_message;
  {  // cx
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * sentinel_interfaces__msg__detection__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of Detection */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("sentinel_interfaces.msg._detection");
  ...
  sentinel_interfaces__msg__Detection * ros_message = (sentinel_interfaces__msg__Detection *)raw_ros_message;
  {  // cx
    PyObject * field = NULL;
