...
{
  new (message_memory) sentinel_interfaces::msg::Detection(_init);
}

void Detection_fini_function(void * message_memory)
{
  auto typed_message = static_cast<sentinel_interfaces::msg::Detection *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Detection_message_member_array[4] = {
  {
    ...
    offsetof(sentinel_interfaces::msg::Detection, cx),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(sentinel_interfaces::msg::Detection, cy),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(sentinel_interfaces::msg::Detection, frame_w),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(sentinel_interfaces::msg::Detection, frame_h),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Detection_message_members = {
  ...
  4,  // number of fields
  sizeof(sentinel_interfaces::msg::Detection),
...
get_message_type_support_handle<sentinel_interfaces::msg::Detection>()
{
  return &::sentinel_interfaces::msg::rosidl_typesupport_introspection_cpp::Detection_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, sentinel_interfaces, msg, Detection)() {
  return &::sentinel_interfaces::msg::rosidl_typesupport_introspection_cpp::Detection_message_type_support_handle;
}
